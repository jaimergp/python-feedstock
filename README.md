...
Installing `python` from the `jaimergp/label/python-zlib-ng` channel can be achieved by adding `jaimergp/label/python-zlib-ng` to your channels with:

```
conda config --add channels jaimergp/label/python-zlib-ng
conda config --set channel_priority strict
```

Once the `jaimergp/label/python-zlib-ng` channel has been enabled, `libpython-static, python` can be installed with `conda`:
...
```
conda search libpython-static --channel jaimergp/label/python-zlib-ng
```

or with `mamba`:

```
mamba search libpython-static --channel jaimergp/label/python-zlib-ng
```
...
mamba repoquery search libpython-static --channel jaimergp/label/python-zlib-ng

# List packages depending on `libpython-static`:
mamba repoquery whoneeds libpython-static --channel jaimergp/label/python-zlib-ng

# List dependencies of `libpython-static`:
mamba repoquery depends libpython-static --channel jaimergp/label/python-zlib-ng
```
